            ...
            <div className="col-2  rounded flex flex-col  px-1 sm:px-5 pb-3 w-full  rounded-1xl ">
                ...
                <div style={{marginLeft:0}} className="flex mt-2 py-2 justify-between p-2  gap-x-2 rounded rounded-1xl text-black  bg-whiteGrey">
                   ...
                   <div>
                       ...
                       <p className="font-bold  text-black text-2xl">{user.public_repos}</p>
                   </div>
                   <div>
                       <h5 className="text-xs">Follwers</h5>
                       <p className="font-bold text-black  text-2xl">{user.followers}</p>
                   </div>
                   <div>
                       <h5 className="text-xs">Following</h5>
                       <p className="font-bold text-black text-2xl">{user.following}</p>
                   </div>
                ...
                <div className="flex flex-wrap bg-whiteGrey  rounded rounded-1xl  px-2 mx-0 mt-2 justify-between" style={{marginLeft:0}}>
                    <div className="icons mt-3 ">
                        <p className="mb-3 text-black  text-xs sm:text-sm xs:text-base">
